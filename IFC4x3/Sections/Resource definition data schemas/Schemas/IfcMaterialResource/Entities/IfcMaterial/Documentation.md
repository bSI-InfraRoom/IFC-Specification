_IfcMaterial_ is a homogeneous or inhomogeneous substance that can be used to form elements (physical products or their components) and describe natural samples (or their composites).
